...
onMounted(async () => {
  try {
    ...
    hasProfilePicture.value = data.hasProfilePicture === true;
  } catch {
      ...
      <main class="profile-content">
        <div class="qr-card">
          ...
          <div class="qr-card-content">
            ...
            <div v-else class="qr-error-state">
              <h3>Geen profielfoto gevonden</h3>
              <p>Je moet eerst een profielfoto instellen op je profielpagina voordat je een QR-code kan genereren.</p>
              <RouterLink to="/student/profiel" class="qr-refresh-btn" style="text-decoration: none; display: inline-block; text-align: center;">
                👤 Ga naar Profiel
              </RouterLink>
            </div>
          </div>
